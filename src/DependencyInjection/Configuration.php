        ...
        $rootNode
            ...
            ->children()
                ...
                ->scalarNode('default_message')
                    ->info('Default message on the public restore loading page.')
                    ->defaultValue('Restoring this site from a verified backup. Please wait…')
                ->end()
                ...
                ->arrayNode('backup')
                    ...
                    ->children()
                        ->arrayNode('include_paths')
                            ->info('Paths relative to kernel.project_dir to include.')
                            ->scalarPrototype()->end()
