...
- **Setup wizard** — Cold start / post-restore: create DB, migrations/schema, minimal SQL, idempotent loaders, super-admin, optional sample data; optional durable progress (`filesystem` / `doctrine` / `chain`) — see [docs/SETUP-WIZARD.md](docs/SETUP-WIZARD.md).
